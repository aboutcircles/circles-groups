...
echo -e "${BLUE}Deploying ActiveOneUsdLBPBacker Condition...${NC}"
...
CONDITION_ADDRESS=$(forge create \
    ...
    --broadcast \
    src/membership-conditions/ActiveOneUsdLBPBackerCondition.sol:ActiveOneUsdLBPBackerCondition \
    | grep "Deployed to" \
    | awk '{print $3}')
...
echo -e "${GREEN}ActiveOneUsdLBPBacker Condition deployed at:${NC} $CONDITION_ADDRESS"

# Save the condition address to a file
echo "$CONDITION_ADDRESS" > "./deployments/ActiveOneUsdLBPBackerCondition-gnosis.txt"
