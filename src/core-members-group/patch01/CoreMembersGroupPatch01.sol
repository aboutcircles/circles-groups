...
import {CoreMembersGroupStorage} from "src/core-members-group/patch01/CoreMembersGroupStoragePatch01.sol";
import "src/membership-conditions/IMembershipCondition.sol";

interface IHubExtended is IHub {
    function treasuries(address group) external returns (address);
}
